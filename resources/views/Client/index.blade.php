          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header bg-default">
               <h3 class="m-0 text-dark"> <i class="fa fa-map-marked-alt"></i> Site List <a href="javascript:void(0)" data-toggle="modal" data-target="#AddModal" class="btn btn-default float-right"><span class="fa fa-plus"></span> CREATE</a></h3>
